...
menuBar.addEventListener("reboot_principal", () => {
  fetch('http://192.168.50.69:3000/reboot', { method: 'POST' })
...
menuBar.addEventListener("reboot_longo", () => {
  fetch('http://192.168.50.69:3001/reboot-longo', { method: 'POST' })
    .then(response => response.json())
    .then(data => {
      console.log(data.message);
    })
